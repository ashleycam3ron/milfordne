...
function custom_login_logo(){
	$path = get_stylesheet_directory_uri().'/images/logo.png';
	$logo = get_stylesheet_directory_uri().'/images/logo.png';
	$images = get_stylesheet_directory_uri().'/images/';
	//$l = getimagesize($path);
	echo '<style type="text/css">
			h1 a { background-image:url("'. $logo .'") !important; background-size:100% !important;width:280px !important;height:120px !important;margin: 0 auto !important;}
